...
if section =="Home":
    ...
    cursor.execute('SELECT MAX(r.points),c.name AS competitor FROM competitor_rankings_table r join competitors_table c on r.competitor_id=c.competitor_id Group by c.name;')
